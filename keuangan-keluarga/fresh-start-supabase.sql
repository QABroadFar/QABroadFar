-- ============================================
-- FRESH START: Complete cleanup and schema application
...
-- Clean up any existing policies (ignore errors if they don't exist)
DO $$ 
BEGIN
    -- Drop policies
...
-- Drop all tables if they exist (this will cascade delete all data)
