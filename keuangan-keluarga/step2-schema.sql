-- ============================================
-- STEP 2: Schema - Run this AFTER cleanup
-- ============================================
...
CREATE INDEX idx_receivables_household ON receivables(household_id);
...
CREATE INDEX idx_recurring_payments_household ON recurring_payments(household_id);
...
SELECT 'Schema application completed successfully!' as status;
